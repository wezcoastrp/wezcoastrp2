...
RegisterNetEvent('ds_core:phase2')
AddEventHandler('ds_core:phase2', function()
	local playerPed = GetPlayerPed(-1)
	local cam = CreateCam("DEFAULT_SCRIPTED_CAMERA", 1)
